                        ...
                        if (sprite == MySprite && Equipment.Length == Options.EquipmentSlots.Count)
                        {
                                ...
                                MyEquipment[equipSlot] < Options.MaxInvItems)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (paperdoll == Options.EquipmentSlots[Options.EquipmentSlots.IndexOf(Options.Equipment.HairSlot)])
                                    {
                                        if (this is Player)
                                        {
                                            var player = (Player)this;
                                            player.DrawCustomSpriteLayer(player.CustomSpriteLayers[(int)Enums.CustomSpriteLayers.Hair], alpha);
                                        } 
                                    }
                                }
                            }
